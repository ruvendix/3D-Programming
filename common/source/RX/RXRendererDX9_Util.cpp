...
// ==================================================================================
// 보조 매크로 함수입니다.
#define CASE_CONVERT_STRING(value)\
case value:\
{\
	szValue = _T(#value);\
	break;\
...
namespace RX
{
	...
	const TCHAR* ConvertD3DFORMATToString(D3DFORMAT surfaceFormat)
	{
		...
		{
			CASE_CONVERT_STRING(D3DFMT_UNKNOWN)
			CASE_CONVERT_STRING(D3DFMT_R8G8B8)
			CASE_CONVERT_STRING(D3DFMT_A8R8G8B8)
			CASE_CONVERT_STRING(D3DFMT_X8R8G8B8)
			CASE_CONVERT_STRING(D3DFMT_R5G6B5)
			CASE_CONVERT_STRING(D3DFMT_X1R5G5B5)
			CASE_CONVERT_STRING(D3DFMT_A1R5G5B5)
			CASE_CONVERT_STRING(D3DFMT_A4R4G4B4)
			CASE_CONVERT_STRING(D3DFMT_R3G3B2)
			CASE_CONVERT_STRING(D3DFMT_A8)
			CASE_CONVERT_STRING(D3DFMT_A8R3G3B2)
			CASE_CONVERT_STRING(D3DFMT_X4R4G4B4)
			CASE_CONVERT_STRING(D3DFMT_A2B10G10R10)
			CASE_CONVERT_STRING(D3DFMT_A8B8G8R8)
			CASE_CONVERT_STRING(D3DFMT_X8B8G8R8)
			CASE_CONVERT_STRING(D3DFMT_G16R16)
			CASE_CONVERT_STRING(D3DFMT_A2R10G10B10)
			CASE_CONVERT_STRING(D3DFMT_A16B16G16R16)			
			CASE_CONVERT_STRING(D3DFMT_A8P8)
			CASE_CONVERT_STRING(D3DFMT_P8)			
			CASE_CONVERT_STRING(D3DFMT_L8)
			CASE_CONVERT_STRING(D3DFMT_A8L8)
			CASE_CONVERT_STRING(D3DFMT_A4L4)			
			CASE_CONVERT_STRING(D3DFMT_V8U8)
			CASE_CONVERT_STRING(D3DFMT_L6V5U5)
			CASE_CONVERT_STRING(D3DFMT_X8L8V8U8)
			CASE_CONVERT_STRING(D3DFMT_Q8W8V8U8)
			CASE_CONVERT_STRING(D3DFMT_V16U16)
			CASE_CONVERT_STRING(D3DFMT_A2W10V10U10)			
			CASE_CONVERT_STRING(D3DFMT_UYVY)
			CASE_CONVERT_STRING(D3DFMT_R8G8_B8G8)
			CASE_CONVERT_STRING(D3DFMT_YUY2)
			CASE_CONVERT_STRING(D3DFMT_G8R8_G8B8)
			CASE_CONVERT_STRING(D3DFMT_DXT1)
			CASE_CONVERT_STRING(D3DFMT_DXT2)
			CASE_CONVERT_STRING(D3DFMT_DXT3)
			CASE_CONVERT_STRING(D3DFMT_DXT4)
			CASE_CONVERT_STRING(D3DFMT_DXT5)			
			CASE_CONVERT_STRING(D3DFMT_D16_LOCKABLE)
			CASE_CONVERT_STRING(D3DFMT_D32)
			CASE_CONVERT_STRING(D3DFMT_D15S1)
			CASE_CONVERT_STRING(D3DFMT_D24S8)
			CASE_CONVERT_STRING(D3DFMT_D24X8)
			CASE_CONVERT_STRING(D3DFMT_D24X4S4)
			CASE_CONVERT_STRING(D3DFMT_D16)			
			CASE_CONVERT_STRING(D3DFMT_D32F_LOCKABLE)
			CASE_CONVERT_STRING(D3DFMT_D24FS8)			
			CASE_CONVERT_STRING(D3DFMT_D32_LOCKABLE)
			CASE_CONVERT_STRING(D3DFMT_S8_LOCKABLE)			
			...
			CASE_CONVERT_STRING(D3DFMT_G16R16F)
			CASE_CONVERT_STRING(D3DFMT_A16B16G16R16F)
			CASE_CONVERT_STRING(D3DFMT_R32F)
			CASE_CONVERT_STRING(D3DFMT_G32R32F)
			CASE_CONVERT_STRING(D3DFMT_A32B32G32R32F)			
			CASE_CONVERT_STRING(D3DFMT_CxV8U8)
			CASE_CONVERT_STRING(D3DFMT_A1)
			CASE_CONVERT_STRING(D3DFMT_A2B10G10R10_XR_BIAS)
			CASE_CONVERT_STRING(D3DFMT_BINARYBUFFER)
		default:
		{
			szValue = _T("사용할 수 없는 서페이스 형식입니다!");
			break;
		}
		}
		return szValue;
	...
	const TCHAR* ConvertD3DXIMAGE_FILEFORMATToString(D3DXIMAGE_FILEFORMAT fileFormat)
	{
		...
		switch (fileFormat)
		{
			CASE_CONVERT_STRING(D3DXIFF_BMP)
			CASE_CONVERT_STRING(D3DXIFF_JPG)
			CASE_CONVERT_STRING(D3DXIFF_TGA)
			CASE_CONVERT_STRING(D3DXIFF_PNG)
			CASE_CONVERT_STRING(D3DXIFF_DDS)
			CASE_CONVERT_STRING(D3DXIFF_PPM)
			CASE_CONVERT_STRING(D3DXIFF_DIB)
			CASE_CONVERT_STRING(D3DXIFF_HDR)
			CASE_CONVERT_STRING(D3DXIFF_PFM)
		default:
		{
			szValue = _T("사용할 수 없는 이미지 형식입니다!");
			break;
		}
		}
		return szValue;
